...
const TopRated = () => {
    return (
        <div className='mb-20'>
            <h2 className="text-center mb-8 text-4xl md:text-5xl font-extrabold">
        Top Rated <span className='bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent'>Providers</span>
      </h2>
            <div className='bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-gradient-move flex md:flex-row flex-col gap-5 items-center justify-around py-10 px-5 lg:px-0'>
                ...
                <div>
                    <img className='w-90 h-73 rounded-xl my-4 hover:scale-105 shadow-2xl' src="https://i.ibb.co.com/zw07q2n/Provider-03.jpg" alt="" />
                ...
                <div>
                    <img className='w-90 h-73 rounded-xl my-4 hover:scale-105 shadow-2xl' src="https://i.ibb.co.com/xtB1QDCz/Provider-01.jpg
" alt="" />
                ...
                <div>
                    <img className='w-90 h-73 rounded-xl my-4 hover:scale-105 shadow-2xl' src="https://i.ibb.co.com/trcZxhS/Provider-02.jpg " alt="" />
